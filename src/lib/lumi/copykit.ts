...
export const COPY = {
  ...
  whatsappOuder: `Hoi, wij oefenen tafels, spelling én AI-wijs met ${BRAND.name}. ${BRAND.slogan} Korte rondes, geen chatbot, tot vier kinderen voor ${euro(PRICE.gezin)} per maand. 7 dagen gratis:`,
  whatsappJuf: `Hoi, ken je ${BRAND.name}? Leerspellen voor rekenen, spelling, klokkijken, topo én AI-wijs — op de Nederlandse kerndoelen. ${BRAND.slogan} School is ${euro(PRICE.school)} per klas per maand, tot 30 leerlingen. 7 dagen proef, geen reclame, geen chatbot. Link:`,

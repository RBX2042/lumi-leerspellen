      ...
      <main>
        <section className="relative overflow-hidden">
          ...
          <div className="relative mx-auto max-w-6xl px-4 pb-10 pt-16">
            ...
            <div className="mt-8 inline-flex items-center gap-3 rounded-full bg-surface px-3 py-2 text-sm shadow-[var(--shadow-card)]">
        ...
        <section className="mx-auto max-w-6xl px-4 pb-16">
            ...
            {PLANS.map((p) => {
              ...
              return (
                <Card
                  ...
                  className={
                    p.highlight
                      ? "rounded-3xl p-6 shadow-[var(--shadow-lift)] ring-2 ring-primary"
          ...
          <section className="relative mt-16 overflow-hidden rounded-3xl bg-ink px-6 py-12 text-primary-fg sm:px-10 lg:grid lg:grid-cols-[1.2fr_0.8fr] lg:items-center lg:gap-8">
          ...
          <section className="mt-12 rounded-3xl bg-surface p-6 shadow-[var(--shadow-card)] sm:p-8">
